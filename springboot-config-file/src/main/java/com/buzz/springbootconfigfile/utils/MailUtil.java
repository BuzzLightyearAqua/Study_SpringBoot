package com.buzz.springbootconfigfile.utils;
...
public class MailUtil {
    ...
    /**
     * 发送邮件
     * @param emailProperties 发件人信息（发件人邮箱,发件人授权码）邮箱服务器信息（邮箱服务器域名,身份验证开关）
     * @param to 收件人邮箱
     * @param title 邮件标题
     * @param content 邮件正文
     * @return
    ...
    public static boolean sendMail(EmailProperties emailProperties,String to,String title,String content) {
        ...
        try {
            //设置发件人
            InternetAddress from = new InternetAddress(emailProperties.getUser());
